...
## [1.2.0] - 2026-02-17
### 🚀 New Features
- **Cognitive Debt Diff**: Compare branches or directories to see if debt is increasing (`cognitive-debt diff main..HEAD`).
- **Change Impact Forecaster**: Predict the risk of modifying a file before you touch it (`cognitive-debt impact src/file.js`).
- **Canonical Documentation**: Added authoritative definitions and articles in `docs/canon/`.

### ⚡ Improvements
- **SEO Optimization**: Enhanced discoverability with high-intent keywords in `package.json`.
- **Authority**: Added `CONTRIBUTING.md` and "Philosophy" section to README.
- **Accuracy**: Improved heuristics for "Time to Understand" metric.
...
### Improved
- **SEO & Discovery**: Enhanced package metadata with richer keywords and description to improve search ranking on npm and search engines.

## [1.1.1] - 2026-02-16

### Fixed
- **Documentation**: Corrected typos and improved clarity in README User Guide.

## [1.1.0] - 2026-02-16

### Added
- **HTML Report Generation**: Create beautiful, interactive dashboards with `--output report.html`. Includes:
    - Score distribution charts.
    - Time breakdown charts.
    - Detailed file metrics and issue navigation.
- **JSON File Output**: Export raw analysis data with `--output report.json`.
- **"Time to Understand" Metric**: Realistic estimation of reading time based on complexity (nesting, parameters, naming).
- **CLI Updates**: Added `--output` flag for file generation.

### Changed
- **UI Improvements**: Updated "Good" grade color to **Blue** for better visibility in reports.
- **Documentation**: Comprehensive User Guide added to README.
